...
@endif
  ...
  اسم المشرف
	         ...
	         <input type="text" name="detail"  value="{{ $project->sup }}" class="sub">

</label>
نوع المشروع
    </label>
	         <input type="text" name="detail"  value="{{ $project->type }}" class="sub">

</label>
    حالة المشروع
    </label>
	         <input type="text" name="detail"  value="{{ $project->status }}" class="sub">

</label>
   عن المشروع
    </label>
	         <input type="text" name="detail"  value="{{ $project->abstract }}" class="sub">

...
@endif
  ...
  <label>
    ...
    اسم المناقش
    <label>
	         <input type="text" name="sup" class="sub">

</label>
    <label>
    نوع المشروع
      <input type="text" name="type" class="sub">
   
    <label>
	<label>
    حالة المشروع
      <input type="text" name="status" class="sub">
   
    <label>
	<label>
  المستخلص
      <input type="text" name="abstract" class="sub">
